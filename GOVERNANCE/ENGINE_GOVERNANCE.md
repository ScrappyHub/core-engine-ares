# ENGINE GOVERNANCE (ACKNOWLEDGEMENT) — ARES
...
- infer user/governance state

## Domain Scope
Engine computes acoustic domain truth only. Any classification is a CORE policy lens, not engine output.
